...
def test_customer_query_creation():
    ...
    return {
        ...
        "actual": actual,
        "evaluation_criteria": {"correctness": "The created object should have the correct attribute values.", "default_values": "If customer_type, urgency, or category are not provided, they should default to \u0027regular\u0027, \u0027normal\u0027, and None respectively.", "type_validation": "The attributes should be of the correct data type (str)."}
    }
@agent_test(
...
def test_classify_query_empty():
    ...
    return {
        ...
        "expected_behavior": expected_behavior,
        "actual": actual,
        "evaluation_criteria": {"default_behavior": "The method should return a sensible default value when the query is empty.", "error_handling": "No exceptions should be raised.", "robustness": "The method should handle empty input gracefully without errors."}
    }
@agent_test(
    criteria=["accuracy", "keyword_matching", "context_awareness"],
    tags=["basic"]
)
def test_classify_query_technical():
    """Tests the classify_query method with a technical issue query."""
    input_data = {"query": "The application is crashing repeatedly. I get an error message."}
    ...
    return {
        ...
        "expected_behavior": expected_behavior,
        "actual": actual,
        "evaluation_criteria": {"accuracy": "The classification should be accurate based on the query content.", "context_awareness": "The classification should consider the context of the query.", "keyword_matching": "The classification should correctly identify keywords related to technical issues."}
    }
@agent_test(
...
def test_classify_query_long_query():
    ...
    return {
        ...
        "expected_behavior": expected_behavior,
        "actual": actual,
        "evaluation_criteria": {"accuracy": "The classification should be accurate despite the length and complexity of the query.", "category_resolution": "The method should resolve the query to the most relevant category or a combined category if multiple are present.", "performance": "The method should handle long input without significant performance degradation.", "robustness": "The method should not crash or raise exceptions due to the long input."}
    }