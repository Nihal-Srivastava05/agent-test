...
@agent_test(
    criteria=["execution", "output_type", "functionality"], tags=["basic", "function"]
)
...
@agent_test(criteria=["robustness", "error_handling"], tags=["edge_case", "function"])
def test_handle_customer_query_edge_case():
    """Test edge cases for handle_customer_query"""
    input_data = {
        "customer_type": "test_customer_type",
        "query": "",
        "urgency": "test_urgency",
    }
