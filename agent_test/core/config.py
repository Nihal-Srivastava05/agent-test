...
class EvaluatorConfig(BaseModel):
    ...
    config: Dict[str, Any] = Field(default_factory=dict, description="Evaluator-specific config")
...
class TestConfig(BaseModel):
    ...
    test_patterns: List[str] = Field(default=["test_*.py"], description="Test file patterns")
...
class LoggingConfig(BaseModel):
    ...
    results_dir: str = Field(".agenttest/results", description="Directory for test results")
...
class Config(BaseModel):
    ...
    testing: TestConfig = Field(default_factory=TestConfig, description="Test execution configuration")
    logging: LoggingConfig = Field(default_factory=LoggingConfig, description="Logging configuration")
    
    # Additional settings
    plugins: List[str] = Field(default_factory=list, description="Plugin modules to load")
    custom_evaluators: Dict[str, str] = Field(default_factory=dict, description="Custom evaluator mappings")
