...
class MetricsEvaluator(BaseEvaluator):
    ...
    def evaluate(self, test_output: Any) -> EvaluationResult:
        ...
        try:
            ...
            if not metrics_config:
                return EvaluationResult(
                    passed=False,
                    error="No metrics configuration found in test output"
                )
            ...
            average_threshold = total_threshold / threshold_count if threshold_count > 0 else None
            ...
            return EvaluationResult(
                passed=False,
                error=f"Metrics evaluation failed: {str(e)}"
            )
    
    def _evaluate_rouge(self, actual: str, reference: str, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _rouge_fallback(self, actual: str, reference: str, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _evaluate_bleu(self, actual: str, reference: str, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _bleu_fallback(self, actual: str, reference: str, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        length_penalty = min(1.0, len(actual_words) / len(reference_words)) if reference_words else 0
    ...
    def _evaluate_meteor(self, actual: str, reference: str, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            meteor_score_val = meteor_score([reference.lower().split()], actual.lower().split())
    ...
    def _meteor_fallback(self, actual: str, reference: str, config: Dict[str, Any]) -> Dict[str, Any]:
