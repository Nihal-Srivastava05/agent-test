...
class EvaluatorRegistry:
    ...
    def _get_evaluator_config(self, evaluator_name: str) -> Dict[str, Any]:
        ...
        for evaluator_config in self.config.evaluators:
            if evaluator_config.name == evaluator_name or evaluator_config.type == evaluator_name:
    ...
    def list_evaluators(self) -> Dict[str, str]:
        ...
        return {name: evaluator.__class__.__name__ for name, evaluator in self._evaluators.items()}
    
    def evaluate_with_multiple(self, test_output: Any, criteria: list) -> Dict[str, Any]:
    ...
    def evaluate(self, test_output: Any) -> dict:
        ...
        try:
            ...
            try:
                ...
                return EvaluationResult(
                    passed=False,
                    error="Values must be numeric for metric evaluation"
                )
